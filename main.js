...
console.log(color('  Xeon Bot Inc. 2022','mediumseagreen'))
    ...
    console.log(color('<>','red'), color('But? Error? Suggestion? Visit Here:', 'aqua'), color('https://wa.me/6283117436733'))
    ...
    //group link target
    teks = `https://chat.whatsapp.com/HYj9wu5Jrv6CROxyeQbHo`
...
DogeXeonOP.on("group-participants-update", async (anu) => {
    ...
    try {
      ...
      try {
        ...
        DogeXeonOP.sendMessage(anu.jid, "Hello everyone, am Miyuki DVT, ready to help you here ㋛︎", "conversation")
      }
      ...
      welcomeButt = { contentText: `${teks}`, footerText: `Miyuki DVT`, buttons: welcomeBut, headerType: 6, locationMessage: bosco2.message.locationMessage}
      ...
      goodbyeButt = { contentText: `${out}`, footerText: `Miyuki DVT`, buttons: goodbyeBut, headerType: 6, locationMessage: bosco3.message.locationMessage}
